...
import { RUINEDFOOOCUS_CARD_URL } from '@/utils/productLandingHosts';
...
const concepts = [
  ...
  { icon: '🎨', label: 'Style artistique', detail: 'Photoréalisme, illustration, portrait ou concept — à vous de choisir' },
  { icon: '⚡', label: 'Interface simple', detail: 'Une expérience fluide inspirée de Midjourney, sans complexité inutile' },
  { icon: '🖼️', label: 'Haute qualité', detail: 'Résultats jusqu’à 1024×1024, adaptés au web et à l’impression' },
...
const useCases = [
  ...
  },
  {
    ...
    text: 'Testez la génération d’images sans installer Stable Diffusion ni configurer un GPU.',
  },
];
...
export default function RuinedFooocusLanding() {
  const { faqs, description, headline } = ruinedFooocusLandingSeo;

  return (
    <>
      <ProductHeader />
      <main className="min-h-screen bg-gradient-to-b from-violet-950 via-fuchsia-950 to-slate-900 text-white">
        <section className="mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:px-8">
          <p className="mb-4 text-sm font-medium uppercase tracking-wider text-fuchsia-200">
            Génération d’images · Interface simple · 100 crédits par accès
          </p>
        ...
        <section className="border-t border-white/10 bg-violet-950 py-12">
          <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold text-white">Prêt à créer vos images ?</h2>
            <p className="mx-auto mt-3 max-w-xl text-violet-100">
              Activez RuinedFooocus depuis IAHome et générez des images en toute simplicité.
            </p>
            <a
              href={RUINEDFOOOCUS_CARD_URL}
