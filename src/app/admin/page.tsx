...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'blog' | 'formation' | 'modules' | 'users' | 'linkedin' | 'menus' | 'tokens' | 'notifications' | 'chatbot'>('overview');
      ...
      if (userAppsData && Array.isArray(userAppsData)) {
        (userAppsData as any[]).forEach(app => {
          ...
          appsByUser[app.user_id].push({
            ...
            module_title: app.modules?.[0]?.title || 'Module inconnu',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        <tr>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm font-medium text-gray-900">Gestion des formations</div>
                            <div className="text-sm text-gray-500">Système de catégories multiples</div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
      ...
      {activeTab === 'chatbot' && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-gray-900">Gestion du Chatbot IA</h2>
            <Link
              href="/admin/chatbot"
              className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 ml-3">Configuration IA</h3>
              </div>
              <p className="text-gray-600 mb-4">
                Configurez l'assistant IA, les modèles utilisés et les paramètres de réponse pour optimiser l'expérience utilisateur.
              </p>
              <Link
                href="/admin/chatbot"
                className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center p-3 border border-gray-200 rounded-lg">
                ...
                <span className="font-medium">Support IA intelligent</span>
              </div>
              <div className="flex items-center p-3 border border-gray-200 rounded-lg">
                <svg className="w-5 h-5 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
