      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="flex justify-end">
            <button
              onClick={async () => {
                const email = (document.getElementById('testEmail') as HTMLInputElement)?.value || 'test@example.com';
                const appName = (document.getElementById('testAppName') as HTMLInputElement)?.value || 'Application Test';
                const userName = (document.getElementById('testUserName') as HTMLInputElement)?.value || 'Utilisateur Test';
                
                console.log('Données envoyées:', { email, appName, userName });
                ...
                try {
                  ...
                  console.log('JSON stringifié:', JSON.stringify(requestData));
