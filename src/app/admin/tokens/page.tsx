...
export default function TokenManagementPage() {
  ...
  const handleDeleteToken = async (tokenId: string) => {
    ...
    // Afficher la confirmation personnalisée
    setShowDeleteConfirm(tokenId);
  };

  const confirmDeleteToken = async () => {
    if (!showDeleteConfirm) return;
    
    const tokenId = showDeleteConfirm;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 pt-20">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8 w-full">
            ...
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
              ...
              <div className="mb-6">
                <p className="text-sm text-gray-500">
                  Êtes-vous sûr de vouloir supprimer ce token ? Cette action est irréversible.
                </p>
              </div>
