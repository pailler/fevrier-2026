...
const DEFAULT_VOTE: Card = {
  ...
  description:
    'Créez un vote simple : nom du scrutin et liste des participants. Un code PIN à 4 chiffres (comme le Photobooth/Videobooth connecté) protège l’administration ; un lien public et un QR code permettent de voter. Une participation par appareil, données sur Supabase.',
  category: 'OUTILS ÉVÉNEMENT',
  price: 50,
  image_url: '/iahome-logo.svg',
};

export default function VoteCardPage({ initialModule }: CardInteractiveProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              ...
              <li>Code PIN à 4 chiffres pour l’espace organisateur (comme le Photobooth/Videobooth connecté)</li>
