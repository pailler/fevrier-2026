...
export default function SentinelleNumeriquePage({ initialModule }: CardInteractiveProps) {
  ...
  const [card, setCard] = useState<CardModuleData | null>(initialModule ?? (sentinelleModule as CardModuleData));
