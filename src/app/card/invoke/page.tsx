...
export default function InvokePage() {
  ...
  const isFreeModule = false; // Invoke est payant
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50">
      ...
      {/* Bannière spéciale pour Invoke */}
      <section className="bg-gradient-to-br from-indigo-600 via-purple-600 to-violet-700 py-8 relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-1 max-w-2xl">
              ...
              <p className="text-xl text-indigo-100 mb-6">
                Invoke vous offre une interface graphique intuitive et puissante pour créer des workflows d'IA complexes avec une flexibilité maximale.
              </p>
            ...
            <div className="flex-1 flex justify-center">
              <div className="relative w-80 h-64">
                ...
                <div className="absolute bottom-0 left-16 w-20 h-20 bg-violet-400 transform rotate-45 opacity-80 animate-pulse"></div>
                <div className="absolute bottom-16 right-16 w-16 h-16 bg-white rounded-full opacity-80 animate-bounce"></div>
                
                {/* Logo interface graphique centré */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-white/95 backdrop-blur-sm rounded-full p-6 shadow-2xl border-2 border-indigo-500/20">
                    <svg className="w-20 h-20" viewBox="0 0 24 24" fill="none">
                      {/* Interface graphique stylisée */}
                      <rect x="2" y="2" width="20" height="20" rx="2" stroke="#6366F1" strokeWidth="2" fill="none"/>
                      
                      {/* Nœuds de workflow */}
                      <circle cx="8" cy="8" r="2" fill="#6366F1" opacity="0.8"/>
                      <circle cx="16" cy="8" r="2" fill="#6366F1" opacity="0.8"/>
                      <circle cx="8" cy="16" r="2" fill="#6366F1" opacity="0.8"/>
                      <circle cx="16" cy="16" r="2" fill="#6366F1" opacity="0.8"/>
                      <circle cx="12" cy="12" r="2" fill="#6366F1" opacity="0.8"/>
                      
                      {/* Connexions entre nœuds */}
                      <path d="M10 8 L14 12" stroke="#6366F1" strokeWidth="1.5" strokeLinecap="round"/>
                      <path d="M14 8 L10 12" stroke="#6366F1" strokeWidth="1.5" strokeLinecap="round"/>
                      <path d="M10 12 L14 16" stroke="#6366F1" strokeWidth="1.5" strokeLinecap="round"/>
                      <path d="M14 12 L10 16" stroke="#6366F1" strokeWidth="1.5" strokeLinecap="round"/>
                      
                      {/* Indicateurs de flux */}
                      <circle cx="10" cy="8" r="0.5" fill="#6366F1" className="animate-pulse">
                        <animate attributeName="opacity" values="0.3;1;0.3" dur="1.5s" repeatCount="indefinite"/>
                      </circle>
                      <circle cx="14" cy="12" r="0.5" fill="#6366F1" className="animate-pulse">
                        <animate attributeName="opacity" values="0.3;1;0.3" dur="1.5s" repeatCount="indefinite" begin="0.3s"/>
                      </circle>
                      <circle cx="10" cy="16" r="0.5" fill="#6366F1" className="animate-pulse">
      ...
      {/* Vidéo Invoke - Zone séparée après la bannière */}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {isCardSelected(card.id) && card.price !== 0 && card.price !== '0' && !alreadyActivatedModules.includes(card.id) && (
                  <button 
                    className="w-3/4 font-semibold py-4 px-6 rounded-2xl transition-all duration-300 flex items-center justify-center space-x-3 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                    onClick={async () => {
                      if (!session) {
      ...
      <section className="bg-gradient-to-br from-indigo-50 via-purple-50 to-violet-50 py-8 w-full relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-10 left-1/4 w-1.5 h-1.5 bg-violet-400/25 rounded-full animate-pulse"></div>
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/50 p-8 sm:p-12 lg:p-16 hover:shadow-3xl transition-all duration-300">
            <div className="prose max-w-none">
              <div className="text-center mb-12">
                <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-indigo-900 via-purple-900 to-violet-900 bg-clip-text text-transparent mb-4">
                  À propos d'Invoke
                </h3>
              ...
              <div className="space-y-8 sm:space-y-12 text-gray-700">
                ...
                <div className="text-center max-w-5xl mx-auto">
                  <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed text-gray-700 mb-6">
                    Invoke est une interface graphique révolutionnaire qui vous permet de créer des workflows d'intelligence artificielle complexes 
                ...
                <div className="max-w-6xl mx-auto space-y-8">
                  {/* Chapitre 1: Qu'est-ce qu'Invoke */}
                  <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-8 rounded-2xl border border-indigo-200 shadow-lg">
                    <div className="flex items-center mb-6">
                      ...
                      <h4 className="text-2xl font-bold text-indigo-900">Qu'est-ce qu'Invoke ?</h4>
                    </div>
                    <div className="space-y-4 text-gray-700">
                      <p className="text-lg leading-relaxed">
                        Invoke est une interface graphique avancée conçue pour créer et exécuter des workflows d'intelligence artificielle complexes. 
                        Contrairement aux interfaces traditionnelles, Invoke utilise un système de nœuds visuels qui vous permet de connecter 
                      ...
                      <p className="text-base leading-relaxed">
                        ...
                        Invoke vous offre les outils nécessaires pour créer des workflows d'IA sophistiqués.
                      </p>
                    </div>
                  </div>

                  {/* Chapitre 2: Pourquoi choisir Invoke */}
                  <div className="bg-gradient-to-r from-purple-50 to-violet-50 p-8 rounded-2xl border border-purple-200 shadow-lg">
                    <div className="flex items-center mb-6">
                      ...
                      <h4 className="text-2xl font-bold text-purple-900">Pourquoi choisir Invoke ?</h4>
                    </div>
                    <div className="space-y-4 text-gray-700">
                      <p className="text-lg leading-relaxed">
                  ...
                  <div className="bg-gradient-to-r from-violet-50 to-blue-50 p-8 rounded-2xl border border-violet-200 shadow-lg">
                    <div className="flex items-center mb-6">
                      <div className="w-12 h-12 bg-violet-500 rounded-full flex items-center justify-center mr-4 shadow-lg">
                        <span className="text-white text-xl font-bold">3</span>
                      </div>
                      <h4 className="text-2xl font-bold text-violet-900">Fonctionnalités avancées</h4>
                    </div>
                    <div className="space-y-4 text-gray-700">
                      <p className="text-lg leading-relaxed">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 my-12">
                  <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-6 sm:p-8 rounded-2xl border border-indigo-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div className="text-center">
                      ...
                      <h4 className="font-bold text-indigo-900 mb-3 text-lg">Interface graphique</h4>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 sm:p-8 rounded-2xl border border-purple-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div className="text-center">
                      ...
                      <h4 className="font-bold text-purple-900 mb-3 text-lg">Workflows modulaires</h4>
                  ...
                  <div className="bg-gradient-to-br from-violet-50 to-violet-100 p-6 sm:p-8 rounded-2xl border border-violet-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div className="text-center">
                      ...
                      <h4 className="font-bold text-violet-900 mb-3 text-lg">Performance</h4>
                ...
                <div className="text-center pt-8">
                  <p className="text-lg sm:text-xl text-gray-700 mb-6 max-w-4xl mx-auto">
                    Prêt à créer des workflows d'IA avancés avec Invoke ? Commencez dès maintenant et découvrez la puissance de l'interface graphique pour l'intelligence artificielle !
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Link href="/register" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
