...
export default function VoiceIsolationPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-1 max-w-2xl">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-4">
                Isolation Vocale par IA : Séparez les sources audio avec précision
              </h1>
      ...
      {/* Section "À propos de" */}
      <section className="bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 py-12 w-full relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/50 p-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li><strong>🎤 Isolation vocale</strong> : Extrait uniquement la voix d'un enregistrement</li>
                <li><strong>🥁 Isolation de batterie</strong> : Sépare la batterie du reste</li>
                <li><strong>🎸 Isolation de basse</strong> : Extrait la ligne de basse</li>
                <li><strong>🎹 Autres instruments</strong> : Isole les autres instruments (guitares, synthés, etc.)</li>
                <li><strong>🎵 Séparation complète</strong> : Extrait toutes les sources en une fois</li>
              </ul>

              <h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Formats supportés</h3>
              <p className="text-gray-700 mb-4">
                L'application supporte les formats <strong>MP3, WAV, M4A, OGG, FLAC et WMA</strong>. Les formats non supportés par les navigateurs (comme WMA) sont automatiquement convertis en WAV avant traitement.
              </p>

              <h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Technologie</h3>
              <p className="text-gray-700 mb-4">
                Basé sur <strong>Demucs v4</strong>, un modèle d'IA de pointe entraîné sur des millions d'heures d'audio pour une séparation de sources de qualité professionnelle. Le modèle utilise une architecture Hybrid Transformer pour une précision maximale.
              </p>

              <h3 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Pour qui ?</h3>
              <p className="text-gray-700 mb-4">
                Parfait pour les <strong>musiciens</strong> qui veulent isoler des instruments pour le remixage, les <strong>producteurs</strong> qui ont besoin de séparer les sources pour le mastering, les <strong>créateurs de contenu</strong> qui veulent extraire des voix pour des remixes, et toute personne qui a besoin de séparer les sources audio d'un enregistrement.
              </p>
            </div>
          </div>
        </div>
