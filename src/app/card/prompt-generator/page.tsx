      ...
      <div className="bg-white/60 backdrop-blur-sm border-b border-gray-200/50 pt-2">
        <div className="max-w-7xl mx-auto px-6 py-1">
          <Breadcrumb 
            items={[
              { label: 'Accueil', href: '/' },
              { label: 'Générateur de Prompts IA' }
            ]}
          />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/50 p-8">
            ...
            <div className="space-y-4 text-gray-700">
              <p className="text-lg">
                Le Générateur de Prompts IA vous permet de créer des prompts optimisés et efficaces 
                pour les modèles de langage (ChatGPT, Claude, Gemini, etc.) en utilisant les meilleures 
                pratiques du prompt engineering basées sur le guide officiel.
              </p>
              <div className="bg-purple-50 border-l-4 border-purple-500 p-4 rounded">
                ...
                <ul className="list-disc list-inside text-purple-800 space-y-1">
                  ...
                  <li>Génération avec OpenAI GPT-4</li>
                      ...
                      if (isAuthenticated && user) {
                        ...
                        try {
                          ...
                          if (response.ok) {
                            ...
                            if (data.success) {
                              console.log('✅ Générateur de Prompts IA activé avec succès');
                              setAlreadyActivatedModules(prev => [...prev, moduleId]);
                              router.push('/encours'); // Redirect to /encours
                            } else {
                              console.error('❌ Erreur activation Générateur de Prompts IA:', data.error);
                          ...
                          console.error('❌ Erreur lors de l\'activation de Générateur de Prompts IA:', error);
                        ...
                        console.log('🔒 Accès Générateur de Prompts IA - Redirection vers connexion');
                  ...
                  >
                    {loading || checkingActivation ? (
                      ...
                      <>
                        ...
                        <span>
                          {isAuthenticated && user ? 'Activez Générateur de Prompts IA (100 tokens)' : 'Connectez-vous pour activer (100 tokens)'}
                        </span>
                      </>
                    )}
                  </button>
