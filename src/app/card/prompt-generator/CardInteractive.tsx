...
export default function PromptGeneratorCardPage({ initialModule }: CardInteractiveProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
              ...
              {!isModuleActivated && (
                <div className="w-full">
                  ...
                  >
                    {loading || checkingActivation ? (
                      <>
                        <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-white flex-shrink-0"></div>
      ...
      <CardPageActivationSection
        ...
        tokenCost={100}
        tokenUnit="par accès"
        apiEndpoint="/api/activate-prompt-generator"
