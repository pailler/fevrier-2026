...
export default function CogStudioPage() {
  ...
  const isFreeModule = false; // CogStudio est payant
  ...
  const accessModuleWithJWT = useCallback(async (moduleTitle: string, moduleId: string) => {
    ...
    try {
      // Rediriger directement vers cogstudio via sous-domaine
      const accessUrl = 'https://cogstudio.iahome.fr';
      console.log('🔗 cogstudio: Accès direct à:', accessUrl);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50 to-teal-50">
      ...
      {/* Bannière spéciale pour CogStudio */}
      <section className="bg-gradient-to-br from-cyan-600 via-teal-600 to-blue-700 py-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            {/* Logo CogStudio animé */}
            <div className="flex-1 flex justify-center">
              <div className="relative w-80 h-64">
                {/* Formes géométriques abstraites */}
                <div className="absolute top-0 left-0 w-24 h-24 bg-cyan-400 rounded-full opacity-80 animate-pulse"></div>
      ...
      {/* Vidéo CogStudio - Zone séparée après la bannière */}
...
{/* Bouton d'activation avec tokens */}
      ...
      <section className="bg-gradient-to-br from-cyan-50 via-teal-50 to-blue-50 py-8 w-full relative overflow-hidden">
        {/* Effet de particules en arrière-plan */}
        <div className="absolute inset-0">
          <div className="absolute top-10 left-10 w-2 h-2 bg-cyan-400/20 rounded-full animate-pulse"></div>
          ...
          <div className="absolute bottom-20 right-1/3 w-1 h-1 bg-cyan-400/20 rounded-full animate-bounce"></div>
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/50 p-8 sm:p-12 lg:p-16 hover:shadow-3xl transition-all duration-300">
            <div className="prose max-w-none">
              <div className="text-center mb-12">
                <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-cyan-900 via-teal-900 to-blue-900 bg-clip-text text-transparent mb-4">
                  À propos de CogStudio
                </h3>
              ...
              <div className="space-y-8 sm:space-y-12 text-gray-700">
                ...
                <div className="max-w-6xl mx-auto space-y-8">
                  {/* Chapitre 1: Qu'est-ce que CogStudio */}
                  <div className="bg-gradient-to-r from-cyan-50 to-teal-50 p-8 rounded-2xl border border-cyan-200 shadow-lg">
                    <div className="flex items-center mb-6">
                      ...
                      <h4 className="text-2xl font-bold text-cyan-900">Qu'est-ce que CogStudio ?</h4>
                    </div>
                  ...
                  {/* Chapitre 2: Pourquoi choisir CogStudio */}
                  <div className="bg-gradient-to-r from-teal-50 to-blue-50 p-8 rounded-2xl border border-teal-200 shadow-lg">
                    <div className="flex items-center mb-6">
                      <div className="w-12 h-12 bg-teal-500 rounded-full flex items-center justify-center mr-4 shadow-lg">
                        <span className="text-white text-xl font-bold">2</span>
                      </div>
                      <h4 className="text-2xl font-bold text-teal-900">Pourquoi choisir CogStudio ?</h4>
                    </div>
                    <div className="space-y-4 text-gray-700">
                      <p className="text-lg leading-relaxed">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-cyan-50 p-8 sm:p-12 rounded-2xl border border-gray-200">
