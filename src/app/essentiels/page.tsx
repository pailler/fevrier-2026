  ...
  return (
    <div className="min-h-screen bg-blue-50 font-sans">
      ...
      <section className="bg-gradient-to-br from-yellow-100 via-green-50 to-green-200 py-16 relative overflow-hidden">
        {/* Effet de particules en arrière-plan - Thème outils essentiels */}
        <div className="absolute inset-0">
          {/* Particules flottantes avec animations variées - Thème outils */}
          ...
          {/* Formes géométriques flottantes - Thème outils */}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-1 max-w-2xl animate-fade-in-up">
              <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-yellow-800 via-green-800 to-green-900 bg-clip-text text-transparent leading-tight mb-4 animate-tools-assemble">
            ...
            <div className="flex-1 flex justify-center animate-fade-in-right">
              <div className="relative w-80 h-64 animate-float-gentle">
                {/* Formes géométriques abstraites avec animations améliorées - Thème outils essentiels */}
                ...
                {/* Nouvelles formes flottantes - Thème outils */}
                ...
                {/* Éléments centraux avec animation - Thème outils essentiels */}
                ...
                {/* Effet de particules autour de l'illustration - Thème outils */}
                ...
                {/* Outils flottants - Thème essentiels */}
                <div className="absolute top-4 left-4 w-8 h-8 bg-yellow-400/40 rounded-full flex items-center justify-center animate-float-slow">
                  <div className="text-xs text-yellow-700 font-bold">⚡</div>
                </div>
                <div className="absolute top-6 right-4 w-8 h-8 bg-green-400/40 rounded-full flex items-center justify-center animate-float-medium">
                  <div className="text-xs text-green-700 font-bold">🔧</div>
                </div>
                <div className="absolute bottom-4 left-4 w-8 h-8 bg-blue-400/40 rounded-full flex items-center justify-center animate-float-fast">
                  <div className="text-xs text-blue-700 font-bold">📁</div>
                </div>
                <div className="absolute bottom-6 right-4 w-8 h-8 bg-purple-400/40 rounded-full flex items-center justify-center animate-float-slow">
                  <div className="text-xs text-purple-700 font-bold">🚀</div>
                </div>
                
                {/* Lignes de connexion animées - Thème outils */}
                <div className="absolute top-8 left-8 w-12 h-0.5 bg-yellow-300/30 rounded-full">
                  <div className="h-full bg-yellow-500/60 rounded-full animate-connection-line"></div>
                </div>
                <div className="absolute top-10 right-8 w-10 h-0.5 bg-green-300/30 rounded-full">
                  <div className="h-full bg-green-500/60 rounded-full animate-connection-line-delayed"></div>
                </div>
                <div className="absolute bottom-8 left-8 w-14 h-0.5 bg-blue-300/30 rounded-full">
                  <div className="h-full bg-blue-500/60 rounded-full animate-connection-line-delayed-2"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <style jsx>{`
        /* Animations personnalisées pour la bannière essentiels */
        ...
        @keyframes connection-line-delayed {
          0% { width: 0; }
          30% { width: 0; }
          100% { width: 100%; }
        }
        
        @keyframes connection-line-delayed-2 {
          0% { width: 0; }
          60% { width: 0; }
          100% { width: 100%; }
        }
        ...
        .animate-tools-assemble {
          animation: tools-assemble 2s ease-out;
        }
        
        .animate-connection-line {
          animation: connection-line 2s ease-in-out;
        }
        
        .animate-connection-line-delayed {
          animation: connection-line-delayed 2.5s ease-in-out;
        }
        
        .animate-connection-line-delayed-2 {
          animation: connection-line-delayed-2 3s ease-in-out;
        }
