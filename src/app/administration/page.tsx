                        ...
                        <div className="flex gap-2">
                          {service.appStoreUrl && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 bg-black hover:bg-gray-800 text-white font-medium py-2 sm:py-2.5 px-2 sm:px-3 rounded-lg transition-all shadow-md hover:shadow-lg text-xs sm:text-sm"
                            >
