# Script pour retirer RuinedFooocus du démarrage automatique de Windows

Write-Host "🛑 Retrait de RuinedFooocus du démarrage automatique" -ForegroundColor Cyan
...
if (Test-Path $batchFilePath) {
    try {
        ...
        Write-Host ""
        Write-Host "✅ RuinedFooocus ne sera plus lancé automatiquement au démarrage de Windows" -ForegroundColor Green
    } catch {
    ...
    Write-Host "   RuinedFooocus n'était peut-être pas configuré pour le démarrage automatique" -ForegroundColor Gray
}
