          ...
          <div className="mb-16">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Achetez des tokens pour utiliser nos applications IA.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border-2 border-blue-600 relative">
                ...
                <div className="text-center mb-4">
                  ...
                  <div className="text-2xl font-bold text-blue-700 mb-1">8 000 tokens</div>
                </div>
                <ul className="space-y-2 mb-6 text-sm">
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                  ...
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-600"><strong>80 utilisations IA</strong></span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-600"><strong>800 utilisations</strong> Apps essentielles</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 relative">
                ...
                <div className="text-center mb-4">
                  ...
                  <div className="text-2xl font-bold text-blue-700 mb-1">30 000 tokens</div>
                </div>
                <ul className="space-y-2 mb-6 text-sm">
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                  ...
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-600"><strong>300 utilisations IA</strong></span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-600"><strong>3 000 utilisations</strong> Apps essentielles</span>
                  </li>
                  <li className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
