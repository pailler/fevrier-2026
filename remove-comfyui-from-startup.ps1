# Script pour retirer ComfyUI du démarrage automatique de Windows

Write-Host "🛑 Retrait de ComfyUI du démarrage automatique" -ForegroundColor Cyan
...
if (Test-Path $batchFilePath) {
    try {
        ...
        Write-Host ""
        Write-Host "✅ ComfyUI ne sera plus lancé automatiquement au démarrage de Windows" -ForegroundColor Green
    } catch {
    ...
    Write-Host "   ComfyUI n'était peut-être pas configuré pour le démarrage automatique" -ForegroundColor Gray
}
