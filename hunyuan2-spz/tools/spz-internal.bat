...
if not exist hunyuan_init_done.txt (
	...
	if %ERRORLEVEL% == 0 (
		...
		rem Next time we do this _spz.bat, the presence of this file will let us skip pip install in this _spz.bat
...
rem For example  _spz.bat --model_path tencent/Hunyuan3D-2mv    will do  main_api.py --model_path tencent/Hunyuan3D-2mv
