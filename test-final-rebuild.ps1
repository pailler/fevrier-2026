...
Write-Host "`n5️⃣ Test des conteneurs Docker..." -ForegroundColor Yellow
...
Write-Host "   - Tunnel Cloudflare: Erreur 530 pour les services externes" -ForegroundColor Yellow
Write-Host "   - Applications externes: Non accessibles via Cloudflare" -ForegroundColor Yellow
