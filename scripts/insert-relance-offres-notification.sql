-- Template "Relance offres IAHome" pour notification_settings
-- À exécuter dans Supabase (SQL Editor) ou en PostgreSQL
-- Colonnes : event_type, event_name (pas "name"), is_enabled, email_template_subject, email_template_body
...
INSERT INTO notification_settings (
  ...
  'relance_offres_iahome',
  'Relance offres IAHome',
  true,
  'Vous utilisez déjà iahome — découvrez nos offres pour aller plus loin',
  $body$
<!DOCTYPE html>
<html>
<head>
