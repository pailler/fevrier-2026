-- Insertion de l'article "Les baromètres d'IA" dans blog_articles (Supabase)
-- Exécuter dans l'éditeur SQL du dashboard Supabase

-- Éviter les doublons : supprimer l'article s'il existe déjà (optionnel)
-- DELETE FROM blog_articles WHERE slug = 'barometres-ia';
...
INSERT INTO blog_articles (
  ...
  'Les baromètres d''IA : à quoi servent-ils et quels sont les critères d''évaluation ?',
  'barometres-ia',
  $content$
...
$content$,
  'Les baromètres d''IA permettent de mesurer et comparer les modèles de langage. Découvrez leur rôle et les principaux critères d''évaluation : MMLU, raisonnement, code, multilingue et robustesse.',
  'resources',
  'IAHome',
  2,
  NOW(),
