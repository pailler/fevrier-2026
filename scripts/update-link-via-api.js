/**
 * Script pour mettre à jour le lien dans l'article via l'API locale
 * Exécuter avec: node scripts/update-link-via-api.js
 */

// D'abord récupérer l'article, puis mettre à jour le contenu
...
<div class="article-content">
  ...
  <p><strong>Prêt à découvrir Stable Diffusion ? <a href="https://iahome.fr/card/stablediffusion" style="color: #2563eb; text-decoration: underline; font-weight: 600;">Obtenir +</a> et commencez à générer vos propres images dès aujourd'hui.</strong></p>
</div>
`;

async function updateArticle() {
  try {
    console.log('📝 Mise à jour de l\'article via l\'API...');
    ...
    if (result.success) {
      ...
      console.log('\n🌐 URL de l\'article: https://iahome.fr/blog/ia-generative-stable-diffusion-alternative-chatbots-commerciaux');
    } else {
