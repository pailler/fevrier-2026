# Script pour démarrer le tunnel avec notre configuration personnalisée
# Utilise le fichier de configuration ssl/cloudflare/config.yml

Write-Host "🚀 Démarrage du tunnel avec configuration personnalisée..." -ForegroundColor Green
...
# Démarrer le tunnel avec la configuration
Write-Host "`n🚀 Démarrage du tunnel avec configuration..." -ForegroundColor Yellow
...
Write-Host "✅ Tunnel démarré avec configuration personnalisée!" -ForegroundColor Green
